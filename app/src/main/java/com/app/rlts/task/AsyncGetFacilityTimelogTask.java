...
public class AsyncGetFacilityTimelogTask extends AsyncTask<String, String, String> {

    ArrayList<Timelog> facilityTimelog = new ArrayList<>();
    public AsyncTimelogResponse delegate;

    public AsyncGetFacilityTimelogTask(AsyncTimelogResponse delegate){
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://192.168.0.104:3000/getFacilityTimelog/web");
        } catch (Exception e) {
            e.printStackTrace();
            return e.getMessage();
        }
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("roomName", params[1]);
